...
public class Ouvrier extends PersonnageHumain{
	...
	private void initValue(final int puiss,	final Adresse ad){
	...
	public void tuVasMourrir(final int puiss, final IAttaquant att) {
		...
		LOG.info("AIIIIIEEEEEUUUUHHH ! Tu fais mal " + ((PersonnageHumain)getMonAttaquant()).getNom()
					+ "... nivVie : " + getNiveauVie());
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof Ouvrier) {
			...
			if ((super.equals((PersonnageHumain)ouv)) 
					&& (puissance.equals(ouv.puissance))
